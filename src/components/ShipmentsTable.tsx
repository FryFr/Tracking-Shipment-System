...
import { statusBucket, statusBucketLabel } from '../utils/status';
                        ...
                        {g.items.map((t, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className="md:flex-[1.2] py-0.5" title={t.status_detail || ''}>
                                        <span className="md:hidden text-white/40 text-[10px] uppercase tracking-wide mr-1">Estado:</span>
                                        <StatusChip status={t.status} label={statusBucketLabel(t.status)} />
                                    </span>
